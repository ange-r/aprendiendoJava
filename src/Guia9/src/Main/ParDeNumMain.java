...
import Servicio.servicioParDeNumeros;


public class ParDeNumMain {

    public static void main(String[] args) {
      
        servicioParDeNumeros ns = new servicioParDeNumeros();
        ParDeNumeros numeros = new ParDeNumeros();
        
        ns.mostrarValores(numeros);
        System.out.println("el mayor de los numeros es"+ns.devolverMayor(numeros));
